  ...
  const entrepreneurial = [
    {
      ...
      role: "Co-founder",
      period: "2025 – Present",
      desc: "Production AI platform for automated QA testing of mobile games. Multimodal agentic workflow using OpenCV/YOLO, PaddleOCR, GPT/Gemini on Android/iOS. FastAPI + Celery + Supabase + Docker on GCP. Built the customer-facing Next.js dashboard.",
